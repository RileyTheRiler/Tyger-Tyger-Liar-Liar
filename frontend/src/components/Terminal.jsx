...
// ⚡ Bolt Optimization: Wrapped in React.memo to prevent re-rendering of existing
// history items when new ones are added. Since history is append-only,
// previous entries never change and shouldn't re-render.
